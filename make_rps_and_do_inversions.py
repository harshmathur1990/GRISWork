...
def make_observation_object(
    ...
    if include_b:
        ...
        obs.weights[ic[core_indice[0]:core_indice[1]], 3] = core_weight / 4
...
def generate_guess_atmos(
    ...
    if previous_output_filename is not None:
        ...
        with h5py.File(previous_output_filename, "r") as f:
            ...
            if include_b:
                blos = f["blong"][()]
                if np.array_equal(blos, np.zeros_like(temp)):
                    blos = np.ones_like(temp) * init_b
...
if __name__ == '__main__':
    ...
    # atmos_files = [
    #     data_path / 'CA_SI_rps_ssf_total_78993_t_0_vlos_0_vturb_0_blong_2_output_atmos_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_sft_total_35579_t_0_vlos_0_vturb_0_blong_2_output_atmos_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_nsf_total_2647_t_0_vlos_0_vturb_0_blong_2_output_atmos_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_fsf_total_261_t_0_vlos_0_vturb_0_blong_2_output_atmos_cycle_B_1.nc'
    # ]

    # profile_files =  [
    #     data_path / 'CA_SI_rps_ssf_total_78993_t_0_vlos_0_vturb_0_blong_2_output_profs_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_sft_total_35579_t_0_vlos_0_vturb_0_blong_2_output_profs_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_nsf_total_2647_t_0_vlos_0_vturb_0_blong_2_output_profs_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_fsf_total_261_t_0_vlos_0_vturb_0_blong_2_output_profs_cycle_B_1.nc'
    # ]

    # output_merged_atmos = data_path / 'combined_output_atmos_cycle_B_1.nc'

    # output_merged_profs = data_path / 'combined_output_profs_cycle_B_1.nc'
    ...
    # atmos_files = [
    #     data_path / 'CA_SI_rps_ssf_total_78993_t_0_vlos_0_vturb_0_blong_2_output_atmos_cycle_B_2.nc',
    #     data_path / 'CA_SI_rps_sft_total_35579_t_0_vlos_0_vturb_0_blong_2_output_atmos_cycle_B_2.nc',
    #     data_path / 'CA_SI_rps_nsf_total_2647_t_0_vlos_0_vturb_0_blong_2_output_atmos_cycle_B_2.nc',
    #     data_path / 'CA_SI_rps_fsf_total_261_t_0_vlos_0_vturb_0_blong_2_output_atmos_cycle_B_2.nc'
    # ]

    # profile_files =  [
    #     data_path / 'CA_SI_rps_ssf_total_78993_t_0_vlos_0_vturb_0_blong_2_output_profs_cycle_B_2.nc',
    #     data_path / 'CA_SI_rps_sft_total_35579_t_0_vlos_0_vturb_0_blong_2_output_profs_cycle_B_2.nc',
    #     data_path / 'CA_SI_rps_nsf_total_2647_t_0_vlos_0_vturb_0_blong_2_output_profs_cycle_B_2.nc',
    ...
    # output_predicted_atmos = data_path / 'predicted_output_004_atmos_B_cycle_ml.nc'
    ...
    #     rps_name='ssf',
    #     label_keyname='final_labels_2',
    #     previous_output_filename=output_predicted_atmos,
    #     smooth_thermo=None,
    #     include_b=True,
    #     smooth_b=None
    # )
    ...
    # atmos_files = [
    #     data_path / 'CA_SI_rps_ssf_total_1835_t_7_vlos_7_vturb_4_blong_2_output_atmos_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_sft_total_2211_t_6_vlos_5_vturb_3_blong_2_output_atmos_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_nsf_total_11_t_9_vlos_7_vturb_4_blong_2_output_atmos_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_fsf_total_6_t_5_vlos_7_vturb_4_blong_2_output_atmos_cycle_B_1.nc'
    # ]

    # profile_files =  [
    #     data_path / 'CA_SI_rps_ssf_total_1835_t_7_vlos_7_vturb_4_blong_2_output_profs_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_sft_total_2211_t_6_vlos_5_vturb_3_blong_2_output_profs_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_nsf_total_11_t_9_vlos_7_vturb_4_blong_2_output_profs_cycle_B_1.nc',
    #     data_path / 'CA_SI_rps_fsf_total_6_t_5_vlos_7_vturb_4_blong_2_output_profs_cycle_B_1.nc'
    # ]

    # output_merged_atmos = data_path / 'combined_output_004_atmos_B_cycle_1.nc'

    # output_merged_profs = data_path / 'combined_output_004_profs_B_cycle_1.nc'
    ...
    # output_predicted_atmos = data_path / 'predicted_output_003_atmos_B_cycle_ml.nc'
